...
router.get('/dictionary/main/reset', 
		body().isArray(),
		body('*.russianWord').isLength({min: 1, max: 30}),
		body('*.englishWord').isLength({min: 1, max: 30}),
...
router.get('/level/correct/exercises', authMiddleware, levelController.getLevelCorrectExercisesWords)
router.get('/level/correct/tests', authMiddleware, levelController.getLevelCorrectTestsWords)
router.get('/level/reset', 
		body().isArray(),
